  ...
  return (
    <div className="space-y-5">
        ...
        <div className="flex items-center gap-5">
          <div className="relative">
            {user?.avatar ? (
              ...
              <div className="flex h-20 w-20 items-center justify-center rounded-full bg-blue-600 text-2xl font-bold text-white" aria-hidden="true">
                {initials}
              </div>
            )}
            <button className="absolute -right-1 -bottom-1 flex h-7 w-7 cursor-pointer items-center justify-center rounded-full bg-slate-900 text-white transition-colors duration-200 hover:bg-slate-700" aria-label="Đổi ảnh đại diện">
      ...
      <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <form className="space-y-4 max-w-md" onSubmit={handleSubmit(onSubmit)} noValidate>
          <div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                value={user?.email ?? ""}
                readOnly
                className="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 pr-24 text-sm text-slate-500 cursor-not-allowed"
              />
