        ...
        <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
          <div>
            ...
            <input
              ...
              autoComplete="email"
              required
              className="w-full rounded-full border border-slate-200 px-4 py-3 text-sm text-slate-900 placeholder-slate-400 transition-all duration-200 focus:border-blue-400 focus:ring-2 focus:ring-blue-100 focus:outline-none"
            />
          </div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                required
                className="w-full rounded-full border border-slate-200 px-4 py-3 pr-12 text-sm text-slate-900 placeholder-slate-400 transition-all duration-200 focus:border-blue-400 focus:ring-2 focus:ring-blue-100 focus:outline-none"
              />
              <button
                type="button"
