    ...
    <div className="w-full max-w-md">
      <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
        ...
        <div className="mb-6 grid grid-cols-2 gap-3">
          <button type="button" className="flex cursor-pointer items-center justify-center gap-2 rounded-full border border-slate-200 px-4 py-2.5 text-sm font-medium text-slate-700 transition-colors duration-200 hover:bg-slate-50">
          ...
          <button type="button" className="flex cursor-pointer items-center justify-center gap-2 rounded-full border border-slate-200 px-4 py-2.5 text-sm font-medium text-slate-700 transition-colors duration-200 hover:bg-slate-50">
            <svg viewBox="0 0 24 24" className="h-4 w-4 fill-current text-[#1877F2]" aria-hidden="true">
        ...
        <form className="space-y-4" onSubmit={handleSubmit(onSubmit)} noValidate>
          ...
          <div>
            <div className="mb-1.5 flex items-center justify-between">
              ...
              <Link href="/forgot-password" className="cursor-pointer text-xs text-blue-600 transition-colors duration-150 hover:text-blue-700">
                Quên mật khẩu?
              </Link>
            </div>
        ...
        <p className="mt-6 text-center text-sm text-slate-500">
          Chưa có tài khoản?{" "}
          <Link href="/register" className="cursor-pointer font-medium text-blue-600 transition-colors duration-150 hover:text-blue-700">
            Đăng ký ngay
          </Link>
        </p>
      </div>
