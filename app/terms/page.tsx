      ...
      <main className="min-h-screen bg-slate-50">
        ...
        <div className="bg-white border-b border-slate-100">
          <div className="max-w-7xl mx-auto px-6 py-3 flex items-center gap-2 text-sm text-slate-400">
            ...
            <span className="text-slate-700 font-medium">Điều khoản sử dụng</span>
          </div>
        </div>
        ...
        <div className="bg-white border-b border-slate-100">
          <div className="max-w-7xl mx-auto px-6 py-10">
            <h1 className="text-2xl sm:text-3xl font-bold text-slate-900 mb-2">Điều khoản sử dụng</h1>
