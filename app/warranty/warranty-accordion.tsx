    ...
    content: (
      <div className="space-y-3 text-sm text-slate-600">
        <p>
          ...
          1800 6789 (miễn phí, 8:00 – 20:00)
        </p>
        <p>
          <span className="font-semibold text-slate-900">Email:</span>{" "}
          warranty@nitrotech.vn
        </p>
        <p>
          <span className="font-semibold text-slate-900">Địa chỉ:</span> 123
          Nguyễn Huệ, Quận 1, TP. Hồ Chí Minh
        </p>
        <p>
          <span className="font-semibold text-slate-900">Giờ tiếp nhận:</span>{" "}
