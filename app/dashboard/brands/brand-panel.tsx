      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1 space-y-2">
          ...
          <input
            ...
            className="w-full rounded-xl border border-border bg-muted/50 px-3 py-2 text-xs text-muted-foreground transition-colors outline-none focus:border-ring focus:bg-background focus:ring-2 focus:ring-ring/20"
          />
        </div>
      </div>
      {showPicker && (
            ...
            <div className="flex items-center justify-between rounded-xl border border-border bg-muted/50 px-4 py-3">
              <div>
                ...
                <p className="text-xs text-muted-foreground/70">
                  Khách hàng có thể thấy thương hiệu này
                </p>
              </div>
              <button
                type="button"
