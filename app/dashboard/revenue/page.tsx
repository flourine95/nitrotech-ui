  ...
  return (
    <div className="mx-auto max-w-7xl space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-500">Phân tích tài chính 6 tháng gần nhất</p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        <div className="rounded-2xl border border-slate-200 bg-white p-5">
          ...
          <div className="mt-1 text-xs font-semibold text-green-600">+12.5% so với kỳ trước</div>
        </div>
        <div className="rounded-2xl border border-slate-200 bg-white p-5">
          ...
          <div className="mt-1 text-xs font-semibold text-green-600">+9.8% so với kỳ trước</div>
        </div>
        <div className="rounded-2xl border border-slate-200 bg-white p-5">
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-6">
        <h2 className="mb-6 text-base font-bold text-slate-900">Doanh thu & Lợi nhuận</h2>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        <div className="rounded-2xl border border-slate-200 bg-white p-6">
          <h2 className="mb-6 text-base font-bold text-slate-900">Doanh thu theo danh mục</h2>
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-6">
          <h2 className="mb-6 text-base font-bold text-slate-900">Top thương hiệu</h2>
