  ...
  return (
    <div className="mx-auto max-w-7xl space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-500">{orders.length} đơn hàng tổng cộng</p>
      </div>
      ...
      <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white">
        <div className="overflow-x-auto">
          ...
          {filtered.length === 0 && (
            <div className="py-16 text-center text-slate-400">Không tìm thấy đơn hàng nào</div>
          )}
        </div>
      </div>
    </div>
