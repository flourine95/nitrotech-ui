...
import { OrderCalloutBanner, DetailSkeleton, OrderPipeline } from './order-detail-components';
          ...
          <section className="border-b border-border/70 pb-8">
            <div className="grid gap-5 px-1">
              ...
              <div className="ml-auto grid w-full max-w-sm gap-3 pt-1">
                ...
                <MoneyRow
                  label="Giảm giá"
                  value={Number(order.discountAmount) > 0 ? `-${formatVnd(Number(order.discountAmount))}` : '—'}
                />
                <Separator />
                      ...
                      <div key={log.id} className="flex gap-3">
                        ...
                        <div className={cn('min-w-0 pb-4', isLast && 'pb-0')}>
                          ...
                          <p className="mt-1 text-xs text-muted-foreground">
                            {formatViDateTime(log.createdAt)}
                          </p>
                        </div>
                      </div>
                    );
