...
export function AssetGrid({ assets, selected, active, onToggle, onSelect }: Props) {
          ...
          >
            ...
            <button
              ...
              className={`absolute top-2 left-2 z-10 flex h-5 w-5 cursor-pointer items-center justify-center rounded-md border-2 transition-all duration-150 ${
                isSel ? "border-indigo-500 bg-indigo-500 opacity-100" : "border-white/80 bg-black/20 opacity-0 group-hover:opacity-100"
              }`}
              aria-label="Chọn ảnh"
            >
              {isSel && (
