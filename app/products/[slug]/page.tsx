          ...
          <div className="grid lg:grid-cols-2 gap-12 mb-16">
            ...
            <div>
              ...
              <div className="flex gap-3 mb-6">
                ...
                <Link
                  href="/compare?add=macbook-pro-m4"
                  className="p-3.5 rounded-full border border-slate-200 text-slate-400 hover:text-blue-500 hover:border-blue-200 transition-colors duration-200 cursor-pointer"
